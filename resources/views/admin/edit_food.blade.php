    ...
    <div class="container-fluid">
        <div class="p30">
            <form class="paper p30 mt30" onkeydown="return event.key != 'Enter';" action="{{url('admin/add-food')}}" method="post" id="add_food_form">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class=" input-field label-float active">
                            <label for="foodname">Food Name:</label>
                            <input type="text" id="foodname"  name="food_name" value="{{$body['food']['food_name']}}">
                    ...
                    <div class="mt40">
                        ...
                        @else
                        <input name="food_type" type="radio" id="radio1" class="with-gap" value="1">
                        <label for="radio1" class="inline">Veg.</label>         
                        <input name="food_type" type="radio" id="radio2" class="with-gap" value="0" checked='checked'>
                        <label for="radio2">Non Veg.</label>
                        @endif         
                    </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="input-field label-float active">
                            ...
                            <input type="text" id="price" name="price" value="{{$body['food']['price']}}">
                            <div class="input-highlight"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class=" input-field label-float active">
                            ...
                            <input type="text" id="selling_price"  name="selling_price" value="{{$body['food']['selling_price']}}">
                            <div class="input-highlight"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="selectpicker show-tick" data-width="100%" name="category" id="food_category">
                                ...
                                @if($body['category'] == $body['food']['category'])
                                <option selected="" value="{{$cat['id']}}">{{$cat['c_name']}}</option>
                                @else
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="related_category[]" class="selectpicker" data-width="100%" multiple  title="Select Related Category" id="food_categories">
                                @foreach($body['category'] as $cat)
                                @foreach(json_decode($body['food']['sub_categories']) as $subcat)
                                @if($cat['id'] == $subcat)
                                <option selected="" value="{{$cat['id']}}">{{$cat['c_name']}}</option>
                                @else
                                <option value="{{$cat['id']}}">{{$cat['c_name']}}</option>
                   ...
                   <div class="col-sm-6">
                        ...
                        <div class="col-xs-6 m-t-20 ">
                            <div class="md-form-group float-label ">
                                <img src="{{$body['food']['main_image']}}" onerror="this.style.display='none'" id="img_preview" alt="Image Preview" width="70" height="70" />
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    CKEDITOR.instances.description.setData(`{!!$body['food']['description']!!}`
);
